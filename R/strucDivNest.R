#' @name strucDivNest
#' @rdname strucDivNest
#' @title Quantify spatial (i.e. horizontal) structural diversity across scales in an arbitrary raster layer. 
#' @description
...
#' @param priorB logical. Should blocks be used for prior estimates? 
...
#' @param delta character, takes three options: \code{"0"}, \code{"1"}, or \code{"2"}. 
...
#' Defaults to \code{FALSE}.
#' @param parallelize logical. Set to \code{parallelize = TRUE} to parallelize the computation on multiple cores.
#' Defaults to \code{FALSE}. 
